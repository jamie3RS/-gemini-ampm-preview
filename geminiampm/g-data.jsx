...
// Each entry powers (a) the flip-tile on the About/Why grids and (b) a
// dedicated SEO landing page at /about-us/accreditations/<slug>/.
// `weight` drives copy depth (strong = headline buyer-search target, weak =
// thin trust-signal page). `pillars` cross-links to the service pillar IDs.
...
const ACCRED_IDS = ACCREDS.map((a) => a.slug);
